...
if(isset($_POST['submit2'])){
	...
	if(mysqli_query($link, $sql)) {
		$msg2 = "Bank detail successfully updated";
		$__user = (new user())->info();
	} else {
        $msg2= "Bank details update failed.";
    };
        ...
        <div class="col-md-12 col-sm-12 col-sx-12">
            <div class="card">
				...
				<div class="card-body">
					...
					<?php sysfunc::html_notice($msg2 ?? null); ?>
					
					<form class="form-horizontal" action="bdetails.php" method="POST" >
						<div class="form-group">
							<label>Bank Name</label>
							<input type="text"  name="bank" placeholder="Bank Name " value="<?php  echo $__user['bank']; ?>" class="form-control">
						</div>
						<div class="form-group">
							<label>Account Name</label>
							<input type="text"  name="accname" placeholder="Account Name"  value="<?php  echo $__user['accname']; ?>" class="form-control">
						</div>
						<div class="form-group">
							<label>Account Number</label>
							<input type="text"  name="accno" placeholder="Account Number "  value="<?php  echo $__user['accno']; ?>" class="form-control">
						</div>
						<div class="form-group">
							<label>Bank Swift</label>
							<input type="text"  name="swiftcode" placeholder="Swift Code "  value="<?php  echo $__user['swiftcode']; ?>" class="form-control">
						</div>
						<button style="" type="submit2" class="btn btn-warning" name="submit2" >
							Update Bank 
						</button>
					</form>
